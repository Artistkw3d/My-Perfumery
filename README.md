...
- تاب **التركيب** للمواد التي هي خليط/ميكسجر (Base، Accord، مادة تجارية مركّبة): اختر مكوّنات الخلطة من قائمة المواد ونسبة كل مكوّن. مساهمات IFRA لكل مكوّن تُحسب تلقائياً داخل التركيبات التي تستخدم الخلطة، وسعر الجرام يُحسب تلقائياً كمتوسط مرجّح من المكوّنات إذا لم يُدخل سعر مباشر للخلطة. شارة خضراء **«خليط»** تظهر بجوار اسم المادة في القائمة عند وجود مكوّنات
